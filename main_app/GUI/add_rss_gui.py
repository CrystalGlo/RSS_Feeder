...
class Ui_AddRssWindow(object):
    def addRss(self):
        ...
        self.rssCategory = self.category_lineEdit.text()
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 170, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.category_lineEdit = QtWidgets.QLineEdit(self.frame)
        self.category_lineEdit.setObjectName("category_lineEdit")
        self.gridLayout.addWidget(self.category_lineEdit, 1, 1, 1, 1)
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 170, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        # self.btn_submit_add.triggered.connect(self.addRss)
        ...
        # self.btn_cancel_add.triggered.connect(AddRssWindow.close)
